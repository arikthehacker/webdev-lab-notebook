...
const forEachPokemon = function showForEachPokemon() {
...
const filterPokemons = function showFilterPokemons(type) {
  return pokemons
...
const searchPokemons = function showSearchPokemons(query) {
  const q = query.toLowerCase();

  return pokemons.filter(function (pokemon) {
    const nameMatches = pokemon.name.toLowerCase().includes(q);

    const typeMatches = pokemon.types.some(function (type) {
